...
<!--  ajouter d'autres composants si necessaire (check, combo ....) en veillant à avoir uniquement des balises <td> (pas de <div> encadrant) -->
...
<xsl:include href="composant/input-ligne.xsl"/>		
<xsl:include href="composant/texte-ligne.xsl"/>
